...
- Unit tests: Every task that involves new functionality MUST be developed alongside new unit tests that test the feature.  Make note of this for each relevant task.
